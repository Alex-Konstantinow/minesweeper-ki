...
public class UsageExample {
	...
	public static void main(String[] args) {
		...
		String[] fields = {
			"anfaenger1-9x9-10.txt",//0 Nicht geschafft -> bei 1000 Iterationen 41.7% gelöst
			"anfaenger2-9x9-10.txt",//1 Nicht geschafft -> bei 1000 Iterationen 62.3% gelöst
			...
			"baby2-3x3-1.txt",//6 Nicht geschafft -> bei 10000 Iterationen 32.1% gelöst
			...
			"baby9-7x7-10.txt",//13 nicht geschafft -> bei 10000 Iterationen 0.0% gelöst
			"fortgeschrittene1-16x16-40.txt",//14 geschafft 100%
			"fortgeschrittene2-16x16-40.txt",//15 nicht geschafft -> bei 100 Iterationen 0.2% gelöst
			"fortgeschrittene3-16x16-40.txt",//16 nicht geschafft -> bei 100 Iterationen 14.0% gelöst
			"fortgeschrittene4-16x16-40.txt",//17 nicht geschafft -> bei 100 Iterationen 0.0% gelöst
			"fortgeschrittene5-16x16-40.txt",//18 nicht geschafft -> bei 100 Iterationen 10.0% gelöst
			"profi1-30x16-99.txt",//19 nicht geschafft -> bei 10 Iterationen 0.0% gelöst
			"profi2-30x16-99.txt",//20 nicht geschafft -> bei 10 Iterationen 0.0% gelöst
			"profi3-30x16-99.txt",//21 nicht geschafft -> bei 10 Iterationen 60.0% gelöst
